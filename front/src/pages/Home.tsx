      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-12 max-w-7xl">
          ...
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <h1 className="text-6xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 bg-clip-text text-transparent">
              程序员做饭指南
            </h1>
            <p className="text-2xl md:text-3xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 font-light">
              发现美食的艺术，掌握烹饪的技巧
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
            ...
            <div className="group animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="h-full apple-glass rounded-3xl overflow-hidden">
                {/* 背景装饰 */}
                ...
                <div className="relative z-10 p-8 text-center h-full flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-4 group-hover:text-blue-600 transition-colors duration-300">做饭指南</h3>
            ...
            <div className="group animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="h-full apple-glass rounded-3xl overflow-hidden">
                {/* 背景装饰 */}
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-orange-500/5 to-yellow-500/5 rounded-full -mr-12 -mt-12"></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-br from-orange-400/5 to-orange-500/5 rounded-full -ml-8 -mb-8"></div>
                ...
                <div className="relative z-10 p-8 text-center h-full flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-4 group-hover:text-orange-600 transition-colors duration-300">星级菜谱</h3>
                  <p className="text-slate-600 mb-8 leading-relaxed flex-grow">
            ...
            <div className="group animate-scale-in" style={{ animationDelay: '0.3s' }}>
              <div className="h-full apple-glass rounded-3xl overflow-hidden">
                {/* 背景装饰 */}
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-green-500/5 to-teal-500/5 rounded-full -mr-12 -mt-12"></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-br from-green-400/5 to-green-500/5 rounded-full -ml-8 -mb-8"></div>
                ...
                <div className="relative z-10 p-8 text-center h-full flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-4 group-hover:text-green-600 transition-colors duration-300">菜品大全</h3>
                  <p className="text-slate-600 mb-8 leading-relaxed flex-grow">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="apple-card-elevated rounded-3xl p-12">
              {/* 背景装饰 */}
              ...
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-pink-500/5 to-orange-500/5 rounded-full -ml-12 -mb-12"></div>
              ...
              <div className="relative z-10 text-center">
                ...
                <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 bg-clip-text text-transparent">
                  为什么选择我们？
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  <div className="text-center group">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 mb-3">智能分析</h3>
                    <p className="text-slate-600 leading-relaxed">AI 驱动的菜品分析和推荐系统，让您的烹饪更加智能高效</p>
                  </div>
                  <div className="text-center group">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 mb-3">数据丰富</h3>
                    <p className="text-slate-600 leading-relaxed">全面的菜品信息和营养数据，科学搭配健康饮食</p>
                  </div>
                  <div className="text-center group">
                    ...
                    <h3 className="text-xl font-semibold text-slate-800 mb-3">精准推荐</h3>
                    <p className="text-slate-600 leading-relaxed">基于个人偏好的智能推荐，发现更多适合您的美味</p>
                  </div>
                </div>
              </div>
            </div>
